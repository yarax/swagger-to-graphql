...
var resolver = function (endpoint, proxyUrl, customHeaders) {
    ...
    return function (_source, args, opts) { return __awaiter(_this, void 0, void 0, function () {
        var proxy, req, _a, host, otherHeaders, method, body, baseUrl, path, query, headers, bodyType, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    method = req.method, body = req.body, baseUrl = req.baseUrl, path = req.path, query = req.query, headers = req.headers, bodyType = req.bodyType;
                    return [4 /*yield*/, request_promise_1.default(__assign({}, (bodyType === 'json' && {
                            json: true,
                            body: body,
                        }), (bodyType === 'formData' && {
                            form: body,
                        }), { qs: query, method: method,
                            headers: headers,
...
var getFields = function (endpoints, isMutation, gqlTypes, proxyUrl, headers) {
    return Object.keys(endpoints)
        ...
        var type = typeMap_1.jsonSchemaTypeToGraphQL(operationId, endpoint.response || { type: 'string' }, 'response', false, gqlTypes, true);
        var gType = {
            type: type,
...
var build = function (swaggerPath, proxyUrl, headers) { return __awaiter(_this, void 0, void 0, function () {
    var swaggerSchema, _a, endpoints, schema;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = swagger_1.addTitlesToJsonSchemas;
                return [4 /*yield*/, swagger_1.loadSchema(swaggerPath)];
            case 1:
                swaggerSchema = _a.apply(void 0, [_b.sent()]);
