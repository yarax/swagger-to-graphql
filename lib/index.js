          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (opts.headers) {
                ...
                req.headers = (0, _assign2.default)(req.headers, otherHeaders, customHeaders);
              } else {
...
var getFields = function getFields(endpoints, isMutation, gqlTypes, proxyUrl, headers) {
  return (0, _keys2.default)(endpoints).filter(function (typeName) {
    ...
    var type = (0, _graphql.GraphQLNonNull)((0, _typeMap.createGQLObject)(endpoint.response, typeName, false, gqlTypes));
    var gType = {
      type: type,
    ...
    return (0, _extends4.default)({}, result, (0, _defineProperty3.default)({}, typeName, gType));
  }, {});
};
