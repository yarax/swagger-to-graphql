    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt('return', (0, _jsonSchemaDerefSync2.default)(pathToSchema));
...
var getParamDetails = function getParamDetails(param) {
  var name = replaceOddChars(param.name);
  var type = param.type;
  var jsonSchema = param.schema || param;
  ...
  (0, _keys2.default)(schema.paths).forEach(function (path) {
    ...
    (0, _keys2.default)(route).forEach(function (method) {
      ...
      var parameterDetails = obj.parameters ? obj.parameters.map(function (param) {
        return getParamDetails(param, schema);
      }) : [];
      var endpoint = {
