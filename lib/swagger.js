...
var request_by_swagger_1 = require("./request-by-swagger");
var globalSchema;
...
exports.getParamDetails = function (param) {
    ...
    if (types_1.isOa3NonBodyParam(param)) {
        var schema = param.schema, required = param.required;
        return {
            name: name,
            swaggerName: swaggerName,
            jsonSchema: __assign({}, schema, (required && { required: required })),
        };
    }
    return {
        name: name,
...
exports.getAllEndPoints = function (schema) {
    ...
    Object.keys(schema.paths).forEach(function (path) {
        ...
        Object.keys(route).forEach(function (method) {
            ...
            //
            if (obj.parameters) {
                parameterDetails = obj.parameters.map(function (param) { return exports.getParamDetails(param); });
            }
            else {
                parameterDetails = [];
            }
            var endpoint = {
                ...
                request: function (graphqlParameters, optBaseUrl) {
                    ...
                    return request_by_swagger_1.getRequestOptions(obj, {
                        request: request,
                        url: url,
                        method: method,
                    });
