...
var getExistingType = function getExistingType(ref, isInputType) {
  ...
  if (!__allTypes[typeName]) {
    var schema = allSchema.definitions[schemaTypeName];
    if (!schema) {
...
var createGQLObjectEx = function createGQLObjectEx(jsonSchema, title, isInputType) {
